...
|-----------|-------------|-----------|-------------|-------------|------|
|Node|Bare CJS|require|sibling|Bare CJS|❌ FAIL|
...
|Node|Bare CJS|require|dependency|Bare CJS|❌ FAIL|
...
|Node|Bare TS|import type|sibling|Literate CJS|🟩 PASS|
...
|Node|Bare TS|import type|dependency|Literate CJS|🟩 PASS|
...
|Node|Literate TS|import type|sibling|Literate CJS|🟩 PASS|
...
|Node|Literate TS|import type|dependency|Literate CJS|🟩 PASS|
