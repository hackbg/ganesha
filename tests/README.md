...
|Node|Bare MJS|static import|sibling|Bare CJS|❌ FAIL|
...
|Node|Bare MJS|static import|dependency|Bare CJS|❌ FAIL|
...
|Node|Bare TS|static import|sibling|Bare CJS|❌ FAIL|
...
|Node|Bare TS|static import|dependency|Bare CJS|❌ FAIL|
...
|Node|Bare TS|import type|sibling|Bare CJS|❌ FAIL|
...
|Node|Bare TS|import type|dependency|Bare CJS|❌ FAIL|
